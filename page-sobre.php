        ...
        <nav
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="" class="breadcrumb-link-light">Home</a>
            </li>
            <li class="breadcrumb-item" aria-current="page">
              <a href="sobre.html" class="breadcrumb-link-light">Sobre nós</a>
            </li>
          </ol>
        </nav>
      </div>
      <div class="container px-awe-32 px-lg-0 pt-awe-40 pb-awe-80">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-7 d-flex flex-column align-items-center">
            <h1
              class="text-light-2 fw-bold fz-24 fz-sm-32 fz-md-40 d-inline-block border-bottom border-4 border-main pb-2 mb-awe-40">
              Conheça a revojus
            </h1>
    ...
    <div class="container px-awe-32 px-lg-0 py-awe-56">
      <div class="row gap-awe-64 gap-md-0">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          ...
          <ol class="text-light-2 ps-3 fz-14">
